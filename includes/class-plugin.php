...
class Mcp_Plugin_Template {

	/**
	 * The single instance of Mcp_Plugin_Template.
	 * @var 	object
	 * @access  private
	 * @since 	1.0.0
	 */
	...
	/**
	 * Main Mcp_Plugin_Template Instance
	 *
	 * Ensures only one instance of Mcp_Plugin_Template is loaded or can be loaded.
	 *
	 * @since 1.0.0
	 * @static
	 * @see Mcp_Plugin_Template()
	 * @return Main Mcp_Plugin_Template instance
	 */
